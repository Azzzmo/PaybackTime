...
public class GridRenderer : MonoBehaviour
{
    ...
    {
        GL.PushMatrix();
        gridGenerator.renderer.material.SetPass(0);
        GL.MultMatrix(gridTransformation);
        GL.Begin(GL.LINES);
        GL.Color(gridGenerator.renderer.material.color); // change the color in the GridGenerator material within the Inspector
    ...
    {
        worldPos = camera.WorldToScreenPoint(worldPos);
