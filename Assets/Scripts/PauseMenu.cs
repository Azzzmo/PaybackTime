...
public class PauseMenu : MonoBehaviour
{
	...
	public string url = "www.adeathtoofar.com";
	...
	bool IsLegal() {
	    return !IsBrowser() || 
	    Application.absoluteURL.StartsWith("http://www.adeathtoofar.com/") ||
	    Application.absoluteURL.StartsWith("http://adeathtoofar.com/");
	...
	void MainPauseMenu() {
	    ...
	    //}
	    if (GUILayout.Button ("Home Page")) {
	        Application.OpenURL("http://www.adeathtoofar.com");
	    }
