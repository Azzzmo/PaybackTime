...
public class MainMenuScript : MonoBehaviour {
	...
	//public Texture[] textureImages = new Texture[20];
	//public Texture[] pics;
	...
	void Start () {
		...
		//exitCreditsButtonRect = new Rect(Screen.width/2 - 528, 100, 528, 70);
		//exitCreditsButtonRect = new Rect(Screen.width/2, Screen.height - 100, 150, 40);
	...
	void Update () {
		...
		if (showingCredits){
			...
			//if(creditsPosition > -2550.0f){   	//-2400.0f){   //TODO change the offset related to screenHeight XXXX
			
			/*
			if (Screen.height >= 900){	
				offset = 2540.0f + 180.0f;  //TODO add and test bigger screen height
			} else if (Screen.height >= 800){  
				offset = 2270.0f + 180.0f;				// 2270 + 
	...
	void ShowMainMenu(){
		...
		//GUI.BeginGroup (new Rect(leftUpX + 0.19F*boxWidth, leftUpY + 0.38F*boxHeight, 0.62F*boxWidth, 0.47F*boxHeight));
	...
	void OnGUI () {
		...
		if (startingGame == false && showingHelp == false && showingCredits == false){   //&& startingWww == false && exitingGame == false ){ 
			...
			//textImageStartLocation = 230 / Screen.height;
			//creditsPosition = Screen.height - 180; //-330f; //TODO change the offset related to screenHeight XXXX
			//creditsPosition = screenHeight + textImageStartLocation*screenHeight;  //not right
		...
		// CREDITS SCREEN
			...
			//GUI.DrawTexture(new Rect(0, 0, Screen.width, Screen.height), blackImage, ScaleMode.StretchToFill);
			...
			//GUI.DrawTexture(new Rect(50, creditsPosition, Screen.width/2 - (50+25), Screen.height*3.1f), creditsTextImageRed, ScaleMode.StretchToFill);
			...
			//GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), creditsImages[timerFindex], ScaleMode.ScaleToFit);
			...
			/*  // Code that was needed earlier to show images as hard coded
			// Images on the right side of screen will be shown one at a time
			if (timerF >= -0.9f && timerF < 40.0f){
				//GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, Screen.width/2 - (25 + 50), Screen.height*4/6), image1, ScaleMode.ScaleToFit);
				//GUI.Label(new Rect(Screen.width/2 + 25, Screen.height/5, Screen.width/2 - (25 + 50), Screen.height/2), image1);			
				//GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), image1, ScaleMode.ScaleToFit);
				GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), creditsImages[0], ScaleMode.ScaleToFit);
			} else if (timerF >= 40.0f && timerF < 80.0f){
				//GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, Screen.width/2 - (25 + 50), Screen.height*4/6), image5, ScaleMode.ScaleAndCrop);
				GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), image2, ScaleMode.ScaleToFit);			
				//GUI.Label(new Rect(Screen.width/2 + 25, Screen.height/5, Screen.width/2 - (25 + 50), Screen.height/2), image2);		
			} else if (timerF >= 80.0f && timerF < 120.0f){
				GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), image3, ScaleMode.ScaleToFit);
				//GUI.Label(new Rect(Screen.width/2 + 25, Screen.height/5, Screen.width/2 - (25 + 50), Screen.height/2), image3);
			} else if (timerF >= 120.0f && timerF < 160.0f){
				GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), image4, ScaleMode.ScaleToFit);
				//GUI.Label(new Rect(Screen.width/2 + 25, Screen.height/5, Screen.width/2 - (25 + 50), Screen.height/2), image4);		
			} else if (timerF >= 160.0f && timerF < 200.0f){
				//GUI.Label(new Rect(Screen.width/2 + 25, Screen.height/5, Screen.width/2 - (25 + 50), Screen.height/2), image5);		
				GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), image5, ScaleMode.ScaleToFit);
			} else if (timerF >= 200.0f && timerF < 240.0f){
				//GUI.Label(new Rect(Screen.width/2 + 25, Screen.height/5, Screen.width/2 - (25 + 50), Screen.height/2), image6);	
				GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), image6, ScaleMode.ScaleToFit);
			} else if (timerF >= 240.0f && timerF < 280.0f){
				//GUI.Label(new Rect(Screen.width/2 + 25, Screen.height/5, Screen.width/2 - (25 + 50), Screen.height/2), image7);		
				GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), image7, ScaleMode.ScaleToFit);
			} else if (timerF >= 280.0f && timerF < 320.0f){
				//GUI.Label(new Rect(Screen.width/2 + 25, Screen.height/5, Screen.width/2 - (25 + 50), Screen.height/2), image8);		
				GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), image8, ScaleMode.ScaleToFit);
			} else if (timerF >= 320.0f && timerF < 360.0f){
				//GUI.Label(new Rect(Screen.width/2 + 25, Screen.height/5, Screen.width/2 - (25 + 50), Screen.height/2), image9);		
				GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), image9, ScaleMode.ScaleToFit);
			} else if (timerF >= 360.0f && timerF < 400.0f){
				//GUI.Label(new Rect(Screen.width/2 + 25, Screen.height/5, Screen.width/2 - (25 + 50), Screen.height/2), image10);		
				GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), image10, ScaleMode.ScaleToFit);
			} else {
				//GUI.Label(new Rect(Screen.width/2 + 25, Screen.height/5, Screen.width/2 - (25 + 50), Screen.height/2), image11);		
				GUI.DrawTexture(new Rect(Screen.width/2 + 25, Screen.height/6, imgCreditsLandscapeWidth, imgCreditsLandscapeHeight), image11, ScaleMode.ScaleToFit);
				if (timerF >= 440.0f){
					timerF = 0.0f;	
				}
			}
			*/
			...
			if(Input.GetKeyDown(KeyCode.Mouse0)){
				//if(exitCreditsButtonRect.Contains(Input.mousePosition )){   //(0,0) coordinate in left down corner
				if(exitCreditsButtonRect.Contains(getTransMousePosition2() )){   //(0,0) coordinate in left down corner
					showingCredits = false;
					audio.Stop();
				}
			}
			//if(exitCreditsButtonRect.Contains(Input.mousePosition )){
		...
		// HELP SCREEN
			...
			// Help menu window 
			//GUI.DrawTexture(new Rect(0.15f*Screen.width, 0, 0.7f*Screen.width, Screen.height), helpImage, ScaleMode.StretchToFill);
		...
		/*
		image1 = (Texture2D)Resources.Load("banner2", typeof(Texture2D));
		image2 = (Texture2D)Resources.Load("IMG_0197", typeof(Texture2D));
		//image2 = (Texture2D)Resources.Load("IMG_0197", typeof(Texture2D));
		//image2 = (Texture2D)Resources.Load("IMG_02", typeof(Texture2D));
		image3 = (Texture2D)Resources.Load("Zombie cake", typeof(Texture2D));
		image4 = (Texture2D)Resources.Load("IMG_04", typeof(Texture2D));
		image5 = (Texture2D)Resources.Load("IMG_05", typeof(Texture2D));
		image6 = (Texture2D)Resources.Load("IMG_06", typeof(Texture2D));
		image7 = (Texture2D)Resources.Load("start-menu-bg", typeof(Texture2D));
		image8 = (Texture2D)Resources.Load("IMG_08", typeof(Texture2D));
		image9 = (Texture2D)Resources.Load("IMG_09", typeof(Texture2D));
		image10 = (Texture2D)Resources.Load("IMG_10", typeof(Texture2D));
		
		image11 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image12 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image13 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image14 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image15 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image16 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image17= (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image18 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image19 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image20 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		
		image21 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image22 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image23 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image24 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image25 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image26 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image27 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image28 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image29 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image30 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		
		image31 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image32 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image33 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image34 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image35 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image36 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image37 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image38 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image39 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		image40 = (Texture2D)Resources.Load("OGLphoto3", typeof(Texture2D));
		*/
